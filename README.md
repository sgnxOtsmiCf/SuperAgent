...
<p align="center">
  <b>🎓 个人学习项目 | 基于 Spring AI 和 Spring Boot 构建的智能体 AI 平台</b>
</p>
...
> 🎓 **本项目为个人学习项目**，旨在深入学习和实践 Spring AI、智能体架构、RAG 等前沿技术。代码可能存在不足之处，欢迎交流探讨！
...
#### 1. 克隆项目
```bash
git clone https://github.com/sgnxotsmicf/SuperAgent.git
cd SuperAgent
```
...
| **模型和Token管理**  | 新增 ModelAndTokenController，暂时只支持查询用户模型配置和模型列表                         |
