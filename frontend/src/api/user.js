...
export const userApi = {
  ...
  // 用户登录-简单版
  // 后端：@PostMapping("/simpleLogin") + @RequestParam
  simpleLogin(data) {
    return request.post('/user/simpleLogin', null, { params: data })
  },
  ...
  // 用户登录-手机号版
  // 后端：@RequestMapping("/LoginWithPhoneCode") + @RequestParam
  loginWithPhoneCode(data) {
    return request.post('/user/LoginWithPhoneCode', null, { params: data })
  },

  // 用户注册-简单版
  // 后端：@RequestMapping("/simpleRegister") + @RequestParam
  simpleRegister(data) {
    return request.post('/user/simpleRegister', null, { params: data })
  },
