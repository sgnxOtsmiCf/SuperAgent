...
export const userProfileApi = {
   ...
   */
  updateUserProfile(userId, dimension, values) {
    return request.put(`/profile/${userId}`, { dimension, values })
  },
   ...
   */
  deleteUserProfile(userId, dimension, value) {
    const params = { dimension }
    if (value) params.value = value
    return request.delete(`/profile/${userId}`, { params })
  }
}
