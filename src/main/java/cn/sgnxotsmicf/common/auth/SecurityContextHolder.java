...
import cn.sgnxotsmicf.common.tools.str.StringUtils;
import com.alibaba.ttl.TransmittableThreadLocal;


/**
 * @Author: lixiang
 * @CreateDate: 2026/5/6 22:52
 * @Version: 1.0
 * @Description: 获取当前线程变量中的 用户id、用户名称、Token等信息 注意： 必须在网关通过请求头的方法传入，同时在HeaderInterceptor拦截器设置值。 否则这里无法获取
 */
